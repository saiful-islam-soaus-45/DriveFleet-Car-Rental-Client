    ...
    return (
        <div className="min-h-screen bg-[#f7f5f0] py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
            <div className="max-w-md w-full text-center">
                ...
                {/* বড় জ্যামিতিক থিম কার্ড */}
                <div className="relative p-[2px] rounded-[2.5rem] bg-gradient-to-br from-[#c1f05d] via-[#d4f77a] to-[#c1f05d] shadow-[0_0_40px_rgba(193,240,93,0.35)] mb-8">
